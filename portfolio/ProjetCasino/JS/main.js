...
function change_im(nbim) { 
    if (place[nbim] !=0) {
        ...
        if (choixim==3){if (gain==divs-1) {
            ...
            $('#dessinTableau').append('<img src="biere_gagne.gif" width="300" height="300" border="0">')
        }}
...
function dessinerTableau() {
    ...
    for (i=0 ; i<largeur ; i++){
        ...
        for (t=0 ; t<longueur ; t++){
            cpt++;
            $("#dessinTableau").append('<td><a href="#" onClick="change_im('+(cpt)+')"><img src="'+non_im+'0.png" width="99" height="99" border="0"></a></td>');
        }
        $("#dessinTableau").append('</tr>');
    }
    $("#dessinTableau").append('</table><p>&nbsp;</p>'+
    '<form name="form1">'+
    '<table width="520" border="1" align="center" bgcolor="#FFA500">'+
